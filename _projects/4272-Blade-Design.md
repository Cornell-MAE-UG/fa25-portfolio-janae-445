...
![Shaded rendering of earlier version]({{ "/assets/images/blade-with-parameters.png" | relative_url }}){: .inline-image-r style="width: 200px"}
...
![Shaded rendering of earlier version]({{ "/assets/images/power-curve.png" | relative_url }}){: .inline-image-r style="width: 200px"}
