...
![Our blades with parameters]({{ "assets/images/blade-with-parameters.png" | relative_url }}){: .inline-image-r style="width: 200px"}
...
![Power Curves]({{ "/assets/images/power-curve.png" | relative_url }}){: .inline-image-l}
